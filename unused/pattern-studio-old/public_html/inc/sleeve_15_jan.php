<div>
    <div style="float: right;">
        ...
        <a href="../inc/sleeveDownload.php" style="color:#ffffff">Download Blouse Sleeve</a>
        </button>
		<button class="btn btn-info" >
        <a href="../savi/saviSleeveDownloadPdf.php" target="_blank" style="color:#ffffff">Download Blouse Sleeve Pdf</a>
        </button>
    </div>
    <div>    
        <p>
