...
<!--  Right Column -->			
				...
				<div>
                	...
                	<div class="form-group">
	      				<label class="control-label col-sm-5" for="shoulder">Shoulder(1) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="bnDepth">Back Neck Depth(3) <span class="red">*</span></label>
	      				<div class="col-sm-3">
...
<!-- Back / Full Length -->
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="blength">Blouse Back Length(4) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="waist">Waist(5) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="chest">Chest(Around)(6) <span class="red">*</span></label>
	      				<div class="col-sm-3">
...
<!-- front Length -->
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="fndepth">Front Neck Depth(8) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="apex">Shoulder to Apex(9) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="slength">Sleeve Length(10) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="saround">Sleeve Around(11) <span class="red">*</span></label>
	      				<div class="col-sm-3">
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="armhole">Armhole(12) <span class="red">*</span></label>
	      				<div class="col-sm-3">
