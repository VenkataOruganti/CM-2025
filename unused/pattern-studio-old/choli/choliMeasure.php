...
<!-- Bust input form                                 
					<div class="form-group">
	      				...
	      				<div class="col-sm-3">
	        				<input type="number" placeholder = "highest Points of Bust" class="form-control" id="bust" name="bust" step="0.01" value="<?php echo $bust;?>">
	      				</div>
...
<!-- end of Front Measurement -->               
				...
				<div class="form-group">
	      				<label class="control-label col-sm-5" for="sopen">Sleeve Round(12) <span class="red">*</span></label>
	      				<div class="col-sm-3">
