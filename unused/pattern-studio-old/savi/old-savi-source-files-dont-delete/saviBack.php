<div>
    <div style="float: right;">
        <span>Download Back Design</span>
        <button class="btn btn-info" >
            <a href="../savi/saviBackDownload.php" style="color:#ffffff">SVG</a>
        </button>
		
		<button class="btn btn-info" >
        <a href="../savi/saviBackDownloadPdf.php" style="color:#ffffff">PDF</a>
        </button>
    </div>
...
<svg width="500" height="550" viewbox = "-50, -20, 500, 550 ">
	<g>
		...
		<path fill="none" stroke="#000000" stroke-width="0.5" stroke-dasharray="10, 5" stroke-miterlimit="10" d="<?php echo $saviBackBrown1;?>" />
...
<!--
<div> Brown: <?php echo  $_SESSION["bbPoint11"] ?></div>
<div> Brown: <?php echo  $_SESSION["bbPoint12"] ?></div>
