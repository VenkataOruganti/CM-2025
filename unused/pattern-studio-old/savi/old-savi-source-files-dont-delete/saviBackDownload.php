...
// -------- Cut Marks session variables ------------- //

        $xPoint11 = $_SESSION["bbPoint11"];
        $xPoint12 = $_SESSION["bbPoint12"];
...
$dataVariable = '<g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000;stroke-width:0.3px; stroke-dasharray:2,2; stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1" d="' . $_SESSION["saviBackBlack"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable1 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["saviBackRed"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable2 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000; stroke-width:0.3px;stroke-linecap:butt;stroke-linejoin:miter;"
       d="' . $_SESSION["saviBackGreen"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable3 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000; stroke-dasharray:2,2; stroke-width:0.2px;stroke-linecap:butt;stroke-linejoin:miter;"
       d="' . $_SESSION["saviBackBrown"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable5 = '<g inkscape:label="Layer 3" inkscape:groupmode="layer" id="layer3" transform="translate(0,123)">        
       <text x="' . $_SESSION["backHApex"] . '"  y="' . $_SESSION["backVApex"] . '" font-size="9" > ' . $_SESSION["cust"] . ' </text> </g>';

$dataVariable6 = '<g inkscape:label="Layer 3" inkscape:groupmode="layer" id="layer3" transform="translate(0,123)">        
       <text x="' . $_SESSION["bbPoint11"] . '"  y="' .$_SESSION["bbPoint12"] . '" font-size="2" > ' . "X" . ' </text> </g>';
