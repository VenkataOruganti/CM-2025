 ...
 * - saviFrontDownload.php,  * - saviBackDownload.php
 * - saviSleeveDownload.php * - saviPattiDownload.php
 * =============================================================================
 */
...
// Patti pattern dimensions (small)
$pattiPatternWidth = (($chest / 4) + 1) * $cIn + $margin;
$pattiPatternHeight = (($blength - $flength) + 4) * $cIn + $margin;
...
$pattiTiling = calculateTiling($pattiPatternWidth, $pattiPatternHeight, $paperWidth, $paperHeight, $overlap);
    ...
    if (!$tiling['needsTiling']) {
        ...
        for ($row = 0; $row < $tilesY; $row++) {
            for ($col = 0; $col < $tilesX; $col++) {
                ...
                // Extract the SVG content and modify viewBox
...
// -----------------------------------------------------------------------------
// PAGE 4: PATTI PATTERN
// -----------------------------------------------------------------------------
generateTiledPages($pdf, $pattiSvg, $pattiTiling, 'Patti', $paperSize, $overlap, $cust);
