...
<body>
	...
	<?php include 'halfstarValidate.php';?>
	
<div><h1 style="font-weight:700; margin-left: 20px;">Deep Neck Blouse Back Designs (HalfStar)</h1></div>
...
<div class="row shadows" style="margin-top: -8px">
	...
	<div class="col-md-4" style="background-color: #F8F9F9; border-right: 5px solid #D6DBDF"><?php include 'halfstarMeasure.php'; ?></div>
...
<!-- design download files -->     
     <div id="design">
      ...
      <div> <?php include 'halfstar01.php';?> </div>
