...
$rawData.=$specVariable;
$rawData.=$dataVariable;
$rawData.=$dataVariable1;
$rawData.=$dataVariable2;
$rawData.=$dataVariable3;
$rawData.=$dataVariable4;
$rawData.=$dataVariable5;
$rawData.=$dataVariable12;
//echo $rawData;

$path =  !strpos($_SERVER['HTTP_HOST'], 'localhost') ?  $_SERVER['DOCUMENT_ROOT'].'/cuttingmaster' 
: $_SERVER['DOCUMENT_ROOT'].'';

// This logic used to download the pdf file.
$path =  strpos($_SERVER['HTTP_HOST'],'localhost') !== false ?  $_SERVER['DOCUMENT_ROOT'].'/cuttingmaster' : $_SERVER['DOCUMENT_ROOT'].'';
require_once($path.'/pdfhelper/downloadpdf.php');
//include_once($_SERVER['DOCUMENT_ROOT']. . '/pdfhelper/downloadpdf.php');
$downloadPdf = new DownloadPdf();
$downloadPdf->DownloadPdfFile($_SESSION["cust"]. "_bback". ".",$rawData);
exit;
?>