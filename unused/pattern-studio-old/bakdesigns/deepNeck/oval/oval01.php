<div>
    <div style="float: right;">
        <button class="btn btn-info" >
            <a href="ovalDownload.php" style="color:#ffffff">Download Oval Pattern</a>
        </button>
    </div>
...
// Back Length
		...
		$ovalGray = $bbPoint1 . $bbPoint2 . $bbPoint3 . $bbPoint4 . $bbPoint5 . $bbPoint6 . $bbPoint7 . $bbPoint8 . $bbPoint9 . $bbPoint10 . "Z";
    
        $_SESSION["ovalGray"] = $ovalGray;
...
//        $sb_point3 = "L" . $seam .",".($bnDepth * $cIn);
        ...
        $ovalBlack = $sb_point1 . $sb_point2 . $sb_point3 . $sb_point5 . $sb_point6 . $sb_point7 . $sb_point7a . $sb_point8 . $sb_point9 . $sb_point10 . $sb_point11;
    
        $_SESSION["ovalBlack"] = $ovalBlack;
...
// -------------- Red line Design ----------- //
	...
	$ovalRed = $point1 . $point2 . $point3 . $point4 . $point5 . $point6 . $point7 . $point8 .  $point10 . $point11;
    
    $_SESSION["ovalRed"] = $ovalRed;
...
<svg width="500" height="450" viewbox = "-50, -20, 500, 450 ">
	<g>
		<path fill="none" stroke="#d3d3d3" stroke-width="0.5" stroke-miterlimit="10" d="<?php echo $ovalGray;?>" />
		
		<path fill="none" stroke="#000" stroke-width="1" stroke-miterlimit="10" d="<?php echo $ovalBlack;?>" />
		<path fill="none" stroke="#ff0000" stroke-width="0.5" stroke-dasharray="5,5" stroke-miterlimit="10" d="<?php echo $ovalRed;?>" />
