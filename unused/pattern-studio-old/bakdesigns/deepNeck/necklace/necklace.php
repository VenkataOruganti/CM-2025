...
<body>
	...
	<?php include 'necklaceValidate.php';?>
	
<div><h1 style="font-weight:700; margin-left: 20px;">Deepneck BlouseBack - Necklace Pattern</h1></div>
...
<div class="row shadows" style="margin-top: -8px">
	...
	<div class="col-md-4" style="background-color: #F8F9F9; border-right: 5px solid #D6DBDF"><?php include 'necklaceMeasure.php'; ?></div>
...
<div>
     <div id="diagram">
        ...
        <span style="margin: auto;">
            <img src="../../../img/necklace.PNG" alt="necklace pattern">
        </span>
	</div>
...
<!-- design download files -->     
     <div id="design">
      ...
      <div> <?php include 'necklace01.php';?> </div>
