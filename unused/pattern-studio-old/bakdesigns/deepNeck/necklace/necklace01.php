<div>
    <div style="float: right;">
        <button class="btn btn-info" >
            <a href="necklaceDownload.php" style="color:#ffffff">Download Blouse Back Design</a>
        </button>
    </div>
    ...
    <div><?php include '../../../inc/deepNeckCV.php';?></div>
...
// Back Length
		...
		$necklaceGray = $bbPoint1 . $bbPoint2 . $bbPoint3 . $bbPoint4 . $bbPoint5 . $bbPoint6 . $bbPoint7 . $bbPoint8 . $bbPoint9 . $bbPoint10 . "Z";
    
        $_SESSION["necklaceGray"] = $necklaceGray;
...
// -------------- Black line design ----------//
        ...
        if ($angleWidth == ''){
            ...
            $sb_point2 = "L" . ($seam + ($angleWidth * $cIn)) .",". ($topMargin + ($bnDepth * ($angleDepth/100) * $cIn));
        }
    
		$sb_point3="Q". (((($fshoulder/2)-$shoulder) *$cIn)+$seam).",".(($bnDepth - 1)*$cIn).",". ($seam + (1 * $cIn)).",".(($bnDepth - 0.8 )*$cIn);
    
		$sb_point3a ="Q". ($seam + (0.1 * $cIn)) .",". (($bnDepth -0.5) *$cIn) .",". $seam .",".($bnDepth*$cIn);
        ...
        $necklaceBlack = $sb_point1 . $sb_point2 . $sb_point3 . $sb_point3a . $sb_point5 . $sb_point6 . $sb_point7 . $sb_point7a . $sb_point8 . $sb_point9 . $sb_point10 . $sb_point11;
    
        $_SESSION["necklaceBlack"] = $necklaceBlack;
...
// -------------- Red line Design ----------- //
	...
	$necklaceRed = $point1 . $point2 . $point3 . $point4 . $point5 . $point6 . $point7 . $point8 .  $point10 . $point11;
    
    $_SESSION["necklaceRed"] = $necklaceRed;
...
<svg width="500" height="450" viewbox = "-50, -20, 500, 450 ">
	<g>
		<path fill="none" stroke="#d3d3d3" stroke-width="0.5" stroke-miterlimit="10" d="<?php echo $necklaceGray;?>" />
		
		<path fill="none" stroke="#000" stroke-width="1" stroke-miterlimit="10" d="<?php echo $necklaceBlack;?>" />
		<path fill="none" stroke="#ff0000" stroke-width="0.5" stroke-dasharray="5,5" stroke-miterlimit="10" d="<?php echo $necklaceRed;?>" />
