...
<!-- Upper Chest Round -->                
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="chest">Upper Chest Round(8) <span class="red">*</span></label>
	      				<div class="col-sm-3">
...
<!-- Bust Around -->       
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="bust">Bust/Chest Round (8a) <span class="red">*</span></label>
	      				<div class="col-sm-3">
	        				<input type="number" placeholder = "" class="form-control" id="bust" name="bust" step="0.01" value="<?php echo $bust;?>">
	      				</div>
...
<!-- end of Front Measurement -->               
					...
					<div class="form-group">
	      				<label class="control-label col-sm-5" for="saround">Arm Round(11) <span class="red">*</span></label>
	      				<div class="col-sm-3">
				...
				<div class="form-group">
	      				<label class="control-label col-sm-5" for="sopen">Sleeve Open(12) <span class="red">*</span></label>
	      				<div class="col-sm-3">
	        				<input type="number" class="form-control" id="sopen" name="sopen" step="0.01" value="<?php echo $sopen;?>">
	      				</div>
