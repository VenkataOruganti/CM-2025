<?php
		session_start();
		$filename = $_SESSION["cust"]. "_kt_back". "."."svg"; // blouse front file name
        ...
        $sBlouseBack = $_SESSION["blouseBackTucks"];
...
$dataVariable = '<g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["ktBackBlack"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable1 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["ktBackRed"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable2 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000; stroke-dasharray:2,2; stroke-width:0.2px;stroke-linecap:butt;stroke-linejoin:miter;"
       d="' . $_SESSION["ktBackGreen"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable3 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000; stroke-dasharray:2,2; stroke-width:0.2px;stroke-linecap:butt;stroke-linejoin:miter;"
       d="' . $_SESSION["ktBackBrown"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable4 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["ktBackTucks"] . '" />"; id="path97" inkscape:connector-curvature="0" /> </g>';
...
exit;
?>
<div><?php echo $_SESSION["blouseBackTucks"];?></div>