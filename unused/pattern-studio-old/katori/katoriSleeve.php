<div>
    <div style="float: right;">
        ...
        <a href="../katori/katoriSleeveDownload.php" style="color:#ffffff">Download Blouse Sleeve</a>
        </button>
    </div>
...
// Sleeve Design
    ...
    $ktSleeveRed = $nPoint1 . $nPoint1a . $nPoint1b . $nPoint2 . $nPoint3 . $nPoint4 . $nPoint5 . $nPoint6 . $nPoint7 . $nPoint8 . $nPoint9 . $nPoint10 . "Z" ;

    $_SESSION["ktSlRed"] = $ktSleeveRed;
...
// Black Line
    ...
    $ktSleeveBlack = $nPoint1 .  $nPoint2 . $nPoint4 .  $nPoint7 .  $nPoint9 .  "Z" ;
    
    $_SESSION["ktSlBlack"] = $ktSleeveBlack;
// rectangle
...
?>
    <div style=" margin: 0 auto;">
        <svg width="500" height="500" viewbox = "-50, -50, 500, 500 ">
            ...
            <g>
            <path fill="none" stroke="#000000" stroke-width="1" stroke-miterlimit="10"  d="<?php echo $ktSleeveBlack;?>" />
            <path fill="none" stroke="#ff0000" stroke-dasharray="5, 5" stroke-width="1" stroke-miterlimit="10"  d="<?php echo $ktSleeveRed;?>" />
        <!--    
