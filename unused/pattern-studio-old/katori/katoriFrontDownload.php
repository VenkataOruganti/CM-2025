<?php
		session_start();
		$filename = $_SESSION["cust"]. "_kt_front". "."."svg"; // blouse front file name
...
$dataVariable = '<g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["ktBlouseFrontBlack"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable1 = '<g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000;stroke-width:0.2px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
       d="' . $_SESSION["ktFrontBlouseGreen"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable2 = '<g inkscape:label="Layer 1" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000;stroke-width:0.2px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
       d="' . $_SESSION["ktFrontBlouseBrown"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable3 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["ktBlouseFrontRed"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';
...
$dataVariable4 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       ...
       d="' . $_SESSION["ktFlTucks"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';

// bottom tucks
$dataVariable5 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000; stroke-dasharray:2,2; stroke-width:0.8px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
       d="' . $_SESSION["ktFbTucks"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';

// right tucks
$dataVariable6 = '<g inkscape:label="Layer 2" inkscape:groupmode="layer" id="layer1" transform="translate(0,123)"> <path
       style="fill:none;stroke:#000000; stroke-dasharray:2,2; stroke-width:0.8px;stroke-linecap:butt;stroke-linejoin:miter;stroke-opacity:1"
       d="' . $_SESSION["ktFrTucks"] . '" />"; id="path96" inkscape:connector-curvature="0" /> </g>';

// file name text
$dataVariable7 = '<g inkscape:label="Layer 3" inkscape:groupmode="layer" id="layer3" transform="translate(0,123)">        
