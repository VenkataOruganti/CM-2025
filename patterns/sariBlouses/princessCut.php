...
/**
 * =============================================================================
 * PRINCESS CUT BLOUSE - Composite Pattern File
 * =============================================================================
 *
 * Combines all pattern pieces for a complete princess cut blouse:
 * - Front panel with Patti (princessCutFront.php)
 ...
 *
 * USAGE:
 *   princessCut.php?customer_id=123&measurement_id=456&mode=dev
 *
 * =============================================================================
 */
...
include __DIR__ . '/princessCutFront.php';   // Sets $frontPatternData (includes patti)
...
<head>
    <meta charset="UTF-8">
    <title>Princess Cut Blouse Pattern - <?php echo htmlspecialchars($customerName); ?></title>
    <style>
...
<body>
    ...
    <div class="header">
        <div>
            <h1>Princess Cut Blouse Pattern</h1>
