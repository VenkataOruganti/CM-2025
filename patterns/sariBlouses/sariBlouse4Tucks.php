...
/**
 * =============================================================================
 * SAREE BLOUSE 4 TUCKS - Composite Pattern File
 * =============================================================================
 *
 * Combines all pattern pieces for a complete saree blouse with 4 tucks:
 * - Front panel with Patti (sariBlouse4TFront.php)
 ...
 *
 * USAGE:
 *   sariBlouse4Tucks.php?customer_id=123&measurement_id=456&mode=dev
 *
 * =============================================================================
 */
...
include __DIR__ . '/sariBlouse4TFront.php';   // Sets $frontPatternData (includes patti)
